...
export default function Square2({ zoom, label, activeLabel, setActive }) {

  const widthVW = 41;              // responsive width
  const aspect = 700 / 510;        // preserve shape
  const gapVW = 2;                 // responsive gap
  const pos = { x: -0.646, y:.28 };
